...
checkpoint = torch.load("checkpoints/best_%s2%s_CharadesEgo_re_al_att_finetuned04.pt"%(args.source_domain, args.target_domain,))
...
checkpoint = torch.load("checkpoints/best_%s2%s_CharadesEgo_projection_fintuned%02d.pt"%(args.source_domain, args.target_domain, args.save_id))
...
acc = 0
save_path = args.source_domain + '2' + args.target_domain + '_CharadesEgo_projection_finetuned%02d/'%(args.save_id)
