...
Here the "Labels" directory contains the labels that we generated by ourselves according to the csv files provided by the CharadesEgo dataset. You can directly download it from https://drive.google.com/file/d/1FoHe_zIy6OWYB0ISpoPEY5M4doOwwm06/view?usp=sharing or run `generate_labels.py` to create it by yourself. 
