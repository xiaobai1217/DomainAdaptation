...
class EPICDOMAINClusters(torch.utils.data.Dataset):
    def __init__(self, split='train', source_domain='D1', target_domain = 'D2', beta=0.999, cfg=None):
        ...
        target_train_file = pd.read_pickle('/home/yzhang8/data/EPIC_KITCHENS_UDA/'+target_domain+"_train.pkl")
        source_train_file = pd.read_pickle('/home/yzhang8/data/EPIC_KITCHENS_UDA/'+source_domain+"_train.pkl")
